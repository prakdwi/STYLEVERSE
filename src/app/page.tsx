  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground font-body overflow-hidden">
      ...
      <div className="flex flex-1 border-t border-white/10 overflow-hidden">
        <aside className="w-80 h-full overflow-y-auto p-4 border-r border-white/10 bg-black/20 backdrop-blur-sm flex flex-col gap-4">
        ...
        <aside className="w-72 h-full overflow-y-auto p-4 border-l border-white/10 bg-black/20 backdrop-blur-sm">
